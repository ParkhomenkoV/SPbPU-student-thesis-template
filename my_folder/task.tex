...
\begin{enumerate}[1.]
	...
	%\item Тема работы (на английском языке): \uline{\thesisTitleEn.} % вероятно после 2020 года
	...
	\end{enumerate}	
		...
		\begin{enumerate}[label=\theenumi\arabic*.]
		\item Нормоконтроль: \uline{\ConsultantNormDegree, \ConsultantNorm.} % 
		\item Разработка программы (алгоритма, метода)\footnote{Возможны также формулировки: <<Вопросы программирования/анализа$\ldots$>>, <<Оценка эффективности/быстродействия$\ldots$>> и другие.}: \uline{\ConsultantExtraDegree, \ConsultantExtra.} % закомментировать при необходимости
		\end{enumerate}
...
%Консультант по ??? \uline{\hspace*{0.1\textheight}\ConsultantExtra}%2020

%Консультант по нормоконтролю \uline{\hspace*{0.1\textheight} \ConsultantNorm}%2020
