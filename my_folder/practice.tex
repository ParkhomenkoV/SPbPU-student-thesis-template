...
\normalfont\uline{\AuthorFull}\footnote{Ф.И.О обучающегося}\\%


\normalsize\uline{\course~курс, \group}\footnote{номер курса обучения и учебной группы}\\%


\normalsize\uline{\thesisSpecialtyCode~\thesisSpecialtyTitle}\footnote{направление подготовки (код и наименование)}\\%


\normalsize\uline{\noindent {\bfseries Место прохождения практики:} {\expandafter \Workplace}.}\footnote{указывается наименование профильной организации или наименование структурного подразделения}\\%


\normalsize\uline{\WorkplaceAddress}\footnote{\SPbPUOfficialShort, фактический адрес}\\%
