...
%%   
%%   <<Стандартная>> компиляция с помощью pdflatex + biber   (2-3 РАЗА)
%%  
...
%%   
%%   Default compilation with pdflatex + biber   (2-3 TIMES)
%%  
...
\setcounter{tskPrint}{1}				 % Выставляем двухстороннюю печать 	
